function [W_wing, W_fuselage, W_landing_gear, W_installed_weight, W_payload, W_FS, W_tot] = mass()
...
S_HT = 2.63; % HT exposed planform area
MAC_HT = ; % HT mean aerodynamic chord
t_c_ratio_HT = 0.365; %HT max thickness-to-chord ratio
AR_HT = 4.7; %HT aspect ratio
Lambda_HT = ; %HT quarter chord sweep angle
lambda_HT = 0.5; %HT taper ratio
V_H = 0.75; %HT volume ratio
elevator_tail_HT = ; %elevator-to-tail chord ratio
...
S_VT = ; % VT exposed planform area
MAC_VT = ; % VT mean aerodynamic chord
t_c_ratio_VT = ; %VT max thickness-to-chord ratio
AR_VT = ; %VT aspect ratio
Lambda_VT = ; %VT quarter chord sweep angle
lambda_VT = 0.3; %VT taper ratio
V_V = ; %VT volume ratio
rudder_tail_VT = ; %rudder-to-tail chord ratio
