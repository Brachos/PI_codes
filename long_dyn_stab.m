function [CL_alpha,CD_alpha,Cm_alpha,CL_u,CD_u,Cm_u,CL_q,CD_q,Cm_q,CL_adot,...
    ...
    static_stability,AOA,alpha_L0,l_f,l_cg,sweep,feet,pound,cl_alpha,l_arm)
% Parameters
% beta = sqrt(1-M^2);
% k = cl_alpha/(2*pi);
...
V_cDM = speedDM;
[bwDM,SwDM,CLw_alphaDM,CDw_alphaDM,CLwDM,CDwDM,DDM,cw_rootDM,cw_tipDM,...
    cw_MACDM,xw_ACDM,yw_ACDM,Vw_fuelDM,sweepDM,cDM,alpha_L0DM] = wing(MDM,Altitude,0.95*MTOW,AOA);

[S_tailDM,Sh_tailDM,Sv_tailDM,c_root_tailDM,c_tip_tailDM, dihedral_angleDM,...
    l_armDM, CL_tailDM, Lambda_TDM,b_tailDM, bv_tailDM, bh_tailDM, W_tailDM,...
    Cn_beta_AhDM, V_vfDM, hight_rootDM, hight_tipDM,rudder_chord_rootDM,...
    rudder_chord_tipDM, rudder_chordDM, S_rudderDM] = v_tail(MTOW,...
    2*b_el,cw_MACDM,sweepDM*180/pi,SwDM,l_f,l_cg,bwDM);

[W_wingDM, W_fuselageDM, W_landing_gear_noseDM, W_landing_gear_mainDM,...
    W_installed_engineDM, W_payloadDM, W_FSDM, W_fuelDM, W_systemDM, W_totDM,...
