function [boom,boom_tip, stringers, area] = Boom_area(cell,cell_tip,stringers, M_x, M_y, M_z, sigma_max,coeff_boom1,span)
...
boom.index_up = cell.index_up;
boom.index_low = cell.index_low;

boom_tip.XZ_up = cell_tip.XZ_up;
boom_tip.XZ_low = cell_tip.XZ_low;
boom_tip.Y = zeros(length(boom_tip.XZ_up(1,:)),1) + span/2;
