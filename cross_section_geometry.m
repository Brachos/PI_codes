...
% or Benjamin Hardy (2023). ellipse_points (https://www.mathworks.com/matlabcentral/fileexchange/82059-ellipse_points), MATLAB Central File Exchange. Retrieved April 19, 2023. 
for j = 1:Stringer.nb
    %maximum section
...
Stringer.delta_y = (y_min - Stringer.position_y)./(Fuselage.x_min - Fuselage.x_max);
Stringer.delta_z = (z_min - Stringer.position_z)./(Fuselage.x_min - Fuselage.x_max);
end
